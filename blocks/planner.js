...
import {ROOT,clip,edit,move,validate,copyCell,pasteCell,fillRegion,cellFromCoordinates} from "./space.mjs";
...
$("#paste-cell").onclick=()=>run(()=>{requireSelection();world.boxes=pasteCell(world.boxes,selected,owner,clipboard);save();say("Cell pasted. Select another destination to repeat.");});
