...
Exported JSON filenames include the local date and time. Front, Top, and Side buttons place the camera on the corresponding axis; the home button restores the perspective view.
